    ...
    <>
      <div className="header-shell">
        <div className="header">
          <h1 className="header-title">DataServe Admin Portal</h1>
      ...
      <div className="chat-area">
        <div className="chat-panel">
          <div className="text-center mb-12">
            <h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-white via-blue-100 to-blue-300 bg-clip-text text-transparent">
              Welcome to DataServe
            </h2>
            <p className="text-xl text-text-dim max-w-2xl mx-auto">
              Powerful SaaS management platform for modern businesses. 
